...
class DiversityCalc:
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg.mlcbPoint.setFilters(QgsMapLayerProxyModel.PointLayer)
            self.dlg.mlcbPoly.setFilters(QgsMapLayerProxyModel.PolygonLayer)
            
            self.dlg.fcbCategory.setFilters(QgsFieldProxyModel.String)
            self.dlg.fcbSpecies.setFilters(QgsFieldProxyModel.String)
            
            self.dlg.fcbCategory.setLayer(self.dlg.mlcbPoly.currentLayer())
            self.dlg.fcbSpecies.setLayer(self.dlg.mlcbPoint.currentLayer())
